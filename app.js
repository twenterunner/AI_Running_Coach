...
function runExecutionBreakdownHtml(r){
 ...
 return`<details id="executionBreakdownFoldout" class="runExecutionBreakdown executionFoldout"><summary><span>Execution breakdown</span><b>${Number.isFinite(score)?score+'/100':'Not scored'}</b></summary><div class="executionFoldoutBody">${runExecutionBreakdownBodyHtml(r)}</div></details>`;
}
