...
function buildPlan(){
 ...
 state.plan=out;state.schemaVersion=6309;save()
}
...
if(state.schemaVersion!==6309){state.plan=[];buildPlan()}else if(!state.plan?.length)buildPlan();
...
renderAll();
console.info('AI Running Coach v6.3 web build 6309');
})();