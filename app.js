...
function buildPlan(){
 ...
 state.plan=out;state.schemaVersion=8200;save()
}
...
if(state.schemaVersion!==8200){state.plan=[];buildPlan()}else if(!state.plan?.length)buildPlan();
