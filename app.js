...
const BUILD=10090, SCHEMA=10090, STORAGE_KEY='arc_v62_web', MIRROR_KEY='arc_v8500_web', BACKUP_KEY='arc_pre8500_backup';
...
function rehabExecutionMeta(check){
 ...
 // Backwards compatibility for check-ins saved before build 10090.
 if(!exercise){
...
const brandVersion=document.querySelector('.brand-copy p');if(brandVersion)brandVersion.textContent=`Race-specific adaptive planning • v10.0.9 · build ${BUILD}`;
...
renderAll();
console.info('AI Running Coach v10.0.9 stable build 10090');
})();