...
if('serviceWorker'in navigator&&(location.protocol==='https:'||['localhost','127.0.0.1'].includes(location.hostname)))navigator.serviceWorker.register(`service-worker.js?v=${BUILD}-ui2`,{updateViaCache:'none'}).then(reg=>reg.update()).catch(()=>{});
