...
const BUILD=9330, SCHEMA=9330, STORAGE_KEY='arc_v62_web', MIRROR_KEY='arc_v8500_web', BACKUP_KEY='arc_pre8500_backup';
...
function renderDashboard(){
 ...
 const timelineLabel=name=>({'Foundation':'Founda<br>tion','Aerobic':'Aerobic','Development':'Develop<br>ment','Endurance':'Endur<br>ance','Specific':'Specific','Peak':'Peak','Taper':'Taper'}[name]||esc(name));
...
const brandVersion=document.querySelector('.brand-copy p');if(brandVersion)brandVersion.textContent=`Race-specific adaptive planning • v9.3.3 · build ${BUILD}`;
...
renderAll();
console.info('AI Running Coach v9.3.3 stable build 9330');
})();