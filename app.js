...
function buildPlan(){
 ...
 state.plan=out;state.schemaVersion=6500;save()
}
...
if(state.schemaVersion!==6500){state.plan=[];buildPlan()}else if(!state.plan?.length)buildPlan();
...
renderAll();
console.info('AI Running Coach v6.4 web build 6401');
})();