...
const BUILD=10080, SCHEMA=10080, STORAGE_KEY='arc_v62_web', MIRROR_KEY='arc_v8500_web', BACKUP_KEY='arc_pre8500_backup';
...
function rehabExecutionMeta(check){
 ...
 // Backwards compatibility for check-ins saved before build 10080.
 if(!exercise){
 ...
 const locomotionMap={
  ...
  partial:{label:'Walking or running target partially completed',short:'Walk/run target partial',className:'partial',score:60,assessed:true},
  stopped:{label:'Walking or running target stopped because of symptoms',short:'Walk/run stopped',className:'stopped',score:25,assessed:true},
  none:{label:'Walking or running target not completed',short:'Walk/run not completed',className:'missed',score:0,assessed:true},
...
const brandVersion=document.querySelector('.brand-copy p');if(brandVersion)brandVersion.textContent=`Race-specific adaptive planning • v10.0.8 · build ${BUILD}`;
...
renderAll();
console.info('AI Running Coach v10.0.8 stable build 10080');
})();