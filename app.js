...
const BUILD=10310, SCHEMA=10310, STORAGE_KEY='arc_v62_web', MIRROR_KEY='arc_v8500_web', BACKUP_KEY='arc_pre8500_backup';
...
const brandVersion=document.querySelector('.brand-copy p');if(brandVersion)brandVersion.textContent=`Race-specific adaptive planning • v10.0.31 · build ${BUILD}`;
...
renderAll();
console.info('AI Running Coach v10.0.31 stable build 10310');
})();