AI Running Coach v10.4.1 Stable — build 14010
...
After upgrading an installed PWA, fully close and reopen it once so cache arc-v1041-stable-14010-premium1 activates. Existing v10.x local data are migrated into schema 10330 and retained under a deterministic primary/mirror storage pair.
...
v10.4.1 Post-run prescription impact and mobile modal fix
----------------------------------------------------------
...
v10.4.1 Weekly pathway commitment
----------------------------------
...
v10.4.1 Scheduled-activity progression fix
-------------------------------------------
...
v10.4.1 Bottom navigation interaction fix
------------------------------------------
...
v10.4.1 Today simplification and evidence clarity
--------------------------------------------------
...
v10.4.1: Top header AI Running Coach title is larger, heavier and pure white.


v10.4.1 Coach-perspective separation
-------------------------------------
...
v10.4.1 Interval FIT intelligence + Weekly Review
--------------------------------------------------
...
v10.4.1 Weekly review pathway clarification
--------------------------------------------
...
v10.4.1 Record-stream interval detection
-----------------------------------------
...
v10.4.1 Stryd per-repetition power + interval score transparency
-----------------------------------------------------------------
...
v10.4.1 Native + developer FIT record power
--------------------------------------------
...
v10.4.1 Drift chart FIT-stream repair
--------------------------------------
...
v10.4.1: Renamed Strength between running exposures to Strength & recovery day; removed WHY THIS IS TODAY'S CALL, the Today-vs-Progress scope footer, and the Progress expand-conclusion instruction.


v10.4.1: Progress Snapshot reordered: Week Distance + Readiness on row 1; Pace & Power + Distance & Load on row 2.


v10.4.1 Readiness Center
-------------------------
...
v10.4.1 Rehabilitation adherence correction
---------------------------------------------
...
v10.4.1 Workout Intelligence 2.0 + Comparable Runs
--------------------------------------------------
...
v10.4.1 Training Decision Engine
--------------------------------
...
v10.4.1 Personal Response Model
-------------------------------
...
v10.4.1 Unified Two-Pathway Decision Engine
-------------------------------------------
...
v10.4.1 Evidence acceptance transparency
