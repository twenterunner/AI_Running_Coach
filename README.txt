AI Running Coach v10.1.0 Stable — build 11000
...
After upgrading an installed PWA, fully close and reopen it once so cache arc-v1010-stable-11000-premium1 activates. Existing v10.x local data are migrated into schema 10330 and retained under a deterministic primary/mirror storage pair.
...
v10.1.0 Post-run prescription impact and mobile modal fix
----------------------------------------------------------
...
v10.1.0 Weekly pathway commitment
----------------------------------
...
v10.1.0 Scheduled-activity progression fix
-------------------------------------------
...
v10.1.0 Bottom navigation interaction fix
------------------------------------------
...
v10.1.0 Today simplification and evidence clarity
--------------------------------------------------
...
v10.1.0: Top header AI Running Coach title is larger, heavier and pure white.


v10.1.0 Coach-perspective separation
-------------------------------------
...
v10.1.0 Interval FIT intelligence + Weekly Review
--------------------------------------------------
...
v10.1.0 Weekly review pathway clarification
--------------------------------------------
...
v10.1.0 Record-stream interval detection
-----------------------------------------
...
v10.1.0 Stryd per-repetition power + interval score transparency
-----------------------------------------------------------------
...
v10.1.0 Native + developer FIT record power
--------------------------------------------
...
v10.1.0 Drift chart FIT-stream repair
--------------------------------------
...
v10.1.0: Renamed Strength between running exposures to Strength & recovery day; removed WHY THIS IS TODAY'S CALL, the Today-vs-Progress scope footer, and the Progress expand-conclusion instruction.


v10.1.0: Progress Snapshot reordered: Week Distance + Readiness on row 1; Pace & Power + Distance & Load on row 2.


v10.1.0 Readiness Center
-------------------------
...
v10.1.0 Rehabilitation adherence correction
---------------------------------------------
...
v10.1.0 Workout Intelligence 2.0 + Comparable Runs
--------------------------------------------------
