AI Running Coach v10.4.6 Stable — build 14060
...
After upgrading an installed PWA, fully close and reopen it once so cache arc-v1046-stable-14060-premium1 activates. Existing v10.x local data are migrated into schema 10330 and retained under a deterministic primary/mirror storage pair.
...
v10.4.6 Post-run prescription impact and mobile modal fix
----------------------------------------------------------
...
v10.4.6 Weekly pathway commitment
----------------------------------
...
v10.4.6 Scheduled-activity progression fix
-------------------------------------------
...
v10.4.6 Bottom navigation interaction fix
------------------------------------------
...
v10.4.6 Today simplification and evidence clarity
--------------------------------------------------
...
v10.4.6: Top header AI Running Coach title is larger, heavier and pure white.


v10.4.6 Coach-perspective separation
-------------------------------------
...
v10.4.6 Interval FIT intelligence + Weekly Review
--------------------------------------------------
...
v10.4.6 Weekly review pathway clarification
--------------------------------------------
...
v10.4.6 Record-stream interval detection
-----------------------------------------
...
v10.4.6 Stryd per-repetition power + interval score transparency
-----------------------------------------------------------------
...
v10.4.6 Native + developer FIT record power
--------------------------------------------
...
v10.4.6 Drift chart FIT-stream repair
--------------------------------------
...
v10.4.6: Renamed Strength between running exposures to Strength & recovery day; removed WHY THIS IS TODAY'S CALL, the Today-vs-Progress scope footer, and the Progress expand-conclusion instruction.


v10.4.6: Progress Snapshot reordered: Week Distance + Readiness on row 1; Pace & Power + Distance & Load on row 2.


v10.4.6 Readiness Center
-------------------------
...
v10.4.6 Rehabilitation adherence correction
---------------------------------------------
...
v10.4.6 Workout Intelligence 2.0 + Comparable Runs
--------------------------------------------------
...
v10.4.6 Training Decision Engine
--------------------------------
...
v10.4.6 Personal Response Model
-------------------------------
...
v10.4.6 Unified Two-Pathway Decision Engine
-------------------------------------------
...
v10.4.6 Evidence acceptance transparency
...
v10.4.6: Fixed accepted Distance & Load run contributions being omitted from the current-week bucket. Simplified post-run pathway UI to Run evidence → Acceptance → This week → Projected next factor; removed duplicate Why/What changed text and repeated numbers.


v10.4.6: Fixed circular JSON save error by removing persisted pathwayTrace/twoPathway objects from coachUpdate. Pathway traces are recomputed on view and contain only plain date/type/contribution rows. Weekly buckets count only non-zero accepted contributions. Post-run UI reduced to Run signal, Accepted into learning, This week, Projected factor, with details behind one foldout.


v10.4.6 Personal-model classification + pathway tile consistency
-----------------------------------------------------------------
...
v10.4.6: Renamed evidence weight to learning confidence weight; shows analysed vs contributed run counts; calculation details expose base confidence weight and multipliers.


v10.4.6 Information architecture cleanup
-----------------------------------------
