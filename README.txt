AI Running Coach v13.7.37 — Shoes graph strategy control + Today visual lock — build 30737
...
AI Running Coach v13.7.37 — hard run-detail spacing + Today teal visual lock — build 30737
...
AI Running Coach v13.7.37 — run duration input + log popup spacing — build 30737
...
AI Running Coach v13.7.37 — authoritative shoe reassignment for logged runs and rehab — build 30737
...
AI Running Coach v13.7.37 — permanent shoe deletion — build 30737
...
AI Running Coach v13.7.37 — rehab shoe persistence + hard shoe lifecycle boundaries — build 30737
...
AI Running Coach v13.7.37 — rehab shoe selection persistence fix — build 30737
...
AI Running Coach v13.7.37 — shoe lifecycle + rehab mileage integrity — build 30737
...
AI Running Coach v13.7.37 — physical-pair lifecycle rollover — build 30737
...
AI Running Coach v13.7.37 — cross-source rehab/run mileage deduplication — build 30737
...
AI Running Coach v13.7.37 — atomic rehab shoe usage — build 30737
...
AI Running Coach v13.7.37 — rehab shoe-mileage estimation fix — build 30737
...
AI Running Coach v13.7.37 — shoe planner render hotfix — build 30737
...
AI Running Coach v13.7.37 — portfolio-optimised shoe purchasing — build 30737
...
AI Running Coach v13.7.37 — visible shoe-mileage confirmation — build 30737
...
AI Running Coach v13.7.37 — immediate shoe-mileage refresh after activity save — build 30737
...
AI Running Coach v13.7.37 — completed-day rehab freeze + future-only shoe projection — build 30737
...
AI Running Coach v13.7.37 — linked shoe-graph lifecycle events — build 30737
...
- VERSION 13.7.37 · BUILD 30737 · SCHEMA 10400.
