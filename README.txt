AI Running Coach v9.9.9 Stable — build 9990
...
Deployment:
Replace all six application files in the GitHub Pages repository. Retain the existing icon files. Fully close and reopen the installed PWA after deployment so cache build 9990 activates.


v9.9.9 Injury update
...
v9.9.9 Check-in and trajectory update
...
v9.9.9 Longitudinal injury scoring update
...
v9.9.9 Rolling rehabilitation calendar
...
v9.9.9 Walking prescription update
