AI Running Coach v13.7.52 — portfolio-first evidence-informed shoe engine — build 30752
...
AI Running Coach v13.7.52 — lifecycle consistency + Race Day hard target — build 30752
...
AI Running Coach v13.7.52 — shoe purchase/use + Race Day target integrity — build 30752
...
AI Running Coach v13.7.52 — offline ASICS catalogue + rational physical-pair lifecycle planner — build 30752
...
AI Running Coach v13.7.52 — differentiated shoe strategies, current-model purchasing, slope explanations, 3-back/4-ahead rehab — build 30752
...
AI Running Coach v13.7.52 — fresh physical-pair lifecycle planner + date-anchored rehab Today — build 30752
...
AI Running Coach v13.7.52 — graph-adjacent shoe strategy + verified live ASICS plan context — build 30752
...
- Corrects runtime and visible revision to v13.7.52 build 30752.
...
AI Running Coach v13.7.52 — rehab check-in prescription consistency — build 30752
...
AI Running Coach v13.7.52 — live ASICS catalogue + gait-aware shoe planning — build 30752
...
AI Running Coach v13.7.52 — Shoes graph strategy control + Today visual lock — build 30752
...
AI Running Coach v13.7.52 — hard run-detail spacing + Today teal visual lock — build 30752
...
AI Running Coach v13.7.52 — run duration input + log popup spacing — build 30752
...
AI Running Coach v13.7.52 — authoritative shoe reassignment for logged runs and rehab — build 30752
...
AI Running Coach v13.7.52 — permanent shoe deletion — build 30752
...
AI Running Coach v13.7.52 — rehab shoe persistence + hard shoe lifecycle boundaries — build 30752
...
AI Running Coach v13.7.52 — rehab shoe selection persistence fix — build 30752
...
AI Running Coach v13.7.52 — shoe lifecycle + rehab mileage integrity — build 30752
...
AI Running Coach v13.7.52 — physical-pair lifecycle rollover — build 30752
...
AI Running Coach v13.7.52 — cross-source rehab/run mileage deduplication — build 30752
...
AI Running Coach v13.7.52 — atomic rehab shoe usage — build 30752
...
AI Running Coach v13.7.52 — rehab shoe-mileage estimation fix — build 30752
...
AI Running Coach v13.7.52 — shoe planner render hotfix — build 30752
...
AI Running Coach v13.7.52 — portfolio-optimised shoe purchasing — build 30752
...
AI Running Coach v13.7.52 — visible shoe-mileage confirmation — build 30752
...
AI Running Coach v13.7.52 — immediate shoe-mileage refresh after activity save — build 30752
...
AI Running Coach v13.7.52 — completed-day rehab freeze + future-only shoe projection — build 30752
...
AI Running Coach v13.7.52 — linked shoe-graph lifecycle events — build 30752
...
- VERSION 13.7.52 · BUILD 30752 · SCHEMA 10400.
