AI Running Coach v13.7.59 — visible rehab forecast + strict retirement boundary — build 30759
...
AI Running Coach v13.7.59 — unified shoe-plan assignments + rehab-visible lifecycle — build 30759
...
AI Running Coach v13.7.59 — expert shoe lifecycle continuity + event-cause fix — build 30759
...
AI Running Coach v13.7.59 — fixed three-mode shoe strategy engine — build 30759
...
AI Running Coach v13.7.59 — continuous active rotation — build 30759
...
AI Running Coach v13.7.59 — retirement-bounded graph + 25% active-rotation floor — build 30759
...
AI Running Coach v13.7.59 — portfolio-first evidence-informed shoe engine — build 30759
...
AI Running Coach v13.7.59 — lifecycle consistency + Race Day hard target — build 30759
...
AI Running Coach v13.7.59 — shoe purchase/use + Race Day target integrity — build 30759
...
AI Running Coach v13.7.59 — offline ASICS catalogue + rational physical-pair lifecycle planner — build 30759
...
AI Running Coach v13.7.59 — differentiated shoe strategies, current-model purchasing, slope explanations, 3-back/4-ahead rehab — build 30759
...
AI Running Coach v13.7.59 — fresh physical-pair lifecycle planner + date-anchored rehab Today — build 30759
...
AI Running Coach v13.7.59 — graph-adjacent shoe strategy + verified live ASICS plan context — build 30759
...
- Corrects runtime and visible revision to v13.7.59 build 30759.
...
AI Running Coach v13.7.59 — rehab check-in prescription consistency — build 30759
...
AI Running Coach v13.7.59 — live ASICS catalogue + gait-aware shoe planning — build 30759
...
AI Running Coach v13.7.59 — Shoes graph strategy control + Today visual lock — build 30759
...
AI Running Coach v13.7.59 — hard run-detail spacing + Today teal visual lock — build 30759
...
AI Running Coach v13.7.59 — run duration input + log popup spacing — build 30759
...
AI Running Coach v13.7.59 — authoritative shoe reassignment for logged runs and rehab — build 30759
...
AI Running Coach v13.7.59 — permanent shoe deletion — build 30759
...
AI Running Coach v13.7.59 — rehab shoe persistence + hard shoe lifecycle boundaries — build 30759
...
AI Running Coach v13.7.59 — rehab shoe selection persistence fix — build 30759
...
AI Running Coach v13.7.59 — shoe lifecycle + rehab mileage integrity — build 30759
...
AI Running Coach v13.7.59 — physical-pair lifecycle rollover — build 30759
...
AI Running Coach v13.7.59 — cross-source rehab/run mileage deduplication — build 30759
...
AI Running Coach v13.7.59 — atomic rehab shoe usage — build 30759
...
AI Running Coach v13.7.59 — rehab shoe-mileage estimation fix — build 30759
...
AI Running Coach v13.7.59 — shoe planner render hotfix — build 30759
...
AI Running Coach v13.7.59 — portfolio-optimised shoe purchasing — build 30759
...
AI Running Coach v13.7.59 — visible shoe-mileage confirmation — build 30759
...
AI Running Coach v13.7.59 — immediate shoe-mileage refresh after activity save — build 30759
...
AI Running Coach v13.7.59 — completed-day rehab freeze + future-only shoe projection — build 30759
...
AI Running Coach v13.7.59 — linked shoe-graph lifecycle events — build 30759
...
- VERSION 13.7.59 · BUILD 30759 · SCHEMA 10400.
