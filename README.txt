AI Running Coach v13.7.51 — lifecycle consistency + Race Day hard target — build 30751
...
AI Running Coach v13.7.51 — shoe purchase/use + Race Day target integrity — build 30751
...
AI Running Coach v13.7.51 — offline ASICS catalogue + rational physical-pair lifecycle planner — build 30751
...
AI Running Coach v13.7.51 — differentiated shoe strategies, current-model purchasing, slope explanations, 3-back/4-ahead rehab — build 30751
...
AI Running Coach v13.7.51 — fresh physical-pair lifecycle planner + date-anchored rehab Today — build 30751
...
AI Running Coach v13.7.51 — graph-adjacent shoe strategy + verified live ASICS plan context — build 30751
...
- Corrects runtime and visible revision to v13.7.51 build 30751.
...
AI Running Coach v13.7.51 — rehab check-in prescription consistency — build 30751
...
AI Running Coach v13.7.51 — live ASICS catalogue + gait-aware shoe planning — build 30751
...
AI Running Coach v13.7.51 — Shoes graph strategy control + Today visual lock — build 30751
...
AI Running Coach v13.7.51 — hard run-detail spacing + Today teal visual lock — build 30751
...
AI Running Coach v13.7.51 — run duration input + log popup spacing — build 30751
...
AI Running Coach v13.7.51 — authoritative shoe reassignment for logged runs and rehab — build 30751
...
AI Running Coach v13.7.51 — permanent shoe deletion — build 30751
...
AI Running Coach v13.7.51 — rehab shoe persistence + hard shoe lifecycle boundaries — build 30751
...
AI Running Coach v13.7.51 — rehab shoe selection persistence fix — build 30751
...
AI Running Coach v13.7.51 — shoe lifecycle + rehab mileage integrity — build 30751
...
AI Running Coach v13.7.51 — physical-pair lifecycle rollover — build 30751
...
AI Running Coach v13.7.51 — cross-source rehab/run mileage deduplication — build 30751
...
AI Running Coach v13.7.51 — atomic rehab shoe usage — build 30751
...
AI Running Coach v13.7.51 — rehab shoe-mileage estimation fix — build 30751
...
AI Running Coach v13.7.51 — shoe planner render hotfix — build 30751
...
AI Running Coach v13.7.51 — portfolio-optimised shoe purchasing — build 30751
...
AI Running Coach v13.7.51 — visible shoe-mileage confirmation — build 30751
...
AI Running Coach v13.7.51 — immediate shoe-mileage refresh after activity save — build 30751
...
AI Running Coach v13.7.51 — completed-day rehab freeze + future-only shoe projection — build 30751
...
AI Running Coach v13.7.51 — linked shoe-graph lifecycle events — build 30751
...
- VERSION 13.7.51 · BUILD 30751 · SCHEMA 10400.
