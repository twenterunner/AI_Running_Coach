AI Running Coach v13.7.58 — unified shoe-plan assignments + rehab-visible lifecycle — build 30758
...
AI Running Coach v13.7.58 — expert shoe lifecycle continuity + event-cause fix — build 30758
...
AI Running Coach v13.7.58 — fixed three-mode shoe strategy engine — build 30758
...
AI Running Coach v13.7.58 — continuous active rotation — build 30758
...
AI Running Coach v13.7.58 — retirement-bounded graph + 25% active-rotation floor — build 30758
...
AI Running Coach v13.7.58 — portfolio-first evidence-informed shoe engine — build 30758
...
AI Running Coach v13.7.58 — lifecycle consistency + Race Day hard target — build 30758
...
AI Running Coach v13.7.58 — shoe purchase/use + Race Day target integrity — build 30758
...
AI Running Coach v13.7.58 — offline ASICS catalogue + rational physical-pair lifecycle planner — build 30758
...
AI Running Coach v13.7.58 — differentiated shoe strategies, current-model purchasing, slope explanations, 3-back/4-ahead rehab — build 30758
...
AI Running Coach v13.7.58 — fresh physical-pair lifecycle planner + date-anchored rehab Today — build 30758
...
AI Running Coach v13.7.58 — graph-adjacent shoe strategy + verified live ASICS plan context — build 30758
...
- Corrects runtime and visible revision to v13.7.58 build 30758.
...
AI Running Coach v13.7.58 — rehab check-in prescription consistency — build 30758
...
AI Running Coach v13.7.58 — live ASICS catalogue + gait-aware shoe planning — build 30758
...
AI Running Coach v13.7.58 — Shoes graph strategy control + Today visual lock — build 30758
...
AI Running Coach v13.7.58 — hard run-detail spacing + Today teal visual lock — build 30758
...
AI Running Coach v13.7.58 — run duration input + log popup spacing — build 30758
...
AI Running Coach v13.7.58 — authoritative shoe reassignment for logged runs and rehab — build 30758
...
AI Running Coach v13.7.58 — permanent shoe deletion — build 30758
...
AI Running Coach v13.7.58 — rehab shoe persistence + hard shoe lifecycle boundaries — build 30758
...
AI Running Coach v13.7.58 — rehab shoe selection persistence fix — build 30758
...
AI Running Coach v13.7.58 — shoe lifecycle + rehab mileage integrity — build 30758
...
AI Running Coach v13.7.58 — physical-pair lifecycle rollover — build 30758
...
AI Running Coach v13.7.58 — cross-source rehab/run mileage deduplication — build 30758
...
AI Running Coach v13.7.58 — atomic rehab shoe usage — build 30758
...
AI Running Coach v13.7.58 — rehab shoe-mileage estimation fix — build 30758
...
AI Running Coach v13.7.58 — shoe planner render hotfix — build 30758
...
AI Running Coach v13.7.58 — portfolio-optimised shoe purchasing — build 30758
...
AI Running Coach v13.7.58 — visible shoe-mileage confirmation — build 30758
...
AI Running Coach v13.7.58 — immediate shoe-mileage refresh after activity save — build 30758
...
AI Running Coach v13.7.58 — completed-day rehab freeze + future-only shoe projection — build 30758
...
AI Running Coach v13.7.58 — linked shoe-graph lifecycle events — build 30758
...
- VERSION 13.7.58 · BUILD 30758 · SCHEMA 10400.
