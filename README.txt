AI Running Coach v10.0.50 Stable — build 10500
...
After upgrading an installed PWA, fully close and reopen it once so cache arc-v1050-stable-10500-premium1 activates. Existing v10.x local data are migrated into schema 10330 and retained under a deterministic primary/mirror storage pair.
...
v10.0.50 Post-run Coach Update
-----------------------------
...
v10.0.50 Post-run prescription impact and mobile modal fix
----------------------------------------------------------
...
v10.0.50 Weekly pathway commitment
----------------------------------
...
v10.0.50 Scheduled-activity progression fix
-------------------------------------------
...
v10.0.50 Bottom navigation interaction fix
------------------------------------------
...
v10.0.50 Today simplification and evidence clarity
--------------------------------------------------
...
v10.0.50: Top header AI Running Coach title is larger, heavier and pure white.


v10.0.50 Coach-perspective separation
-------------------------------------
...
v10.0.50 Interval FIT intelligence + Weekly Review
--------------------------------------------------
...
v10.0.50 Weekly review pathway clarification
--------------------------------------------
...
v10.0.50 Record-stream interval detection
-----------------------------------------
...
v10.0.50 Stryd per-repetition power + interval score transparency
-----------------------------------------------------------------
...
v10.0.50 Native + developer FIT record power
--------------------------------------------
