AI Running Coach v13.7.41 — ASICS live catalogue discovery fix — build 30741
...
AI Running Coach v13.7.41 — shoe-context save + ASICS live refresh + graph-adjacent approach selector — build 30741
...
AI Running Coach v13.7.41 — rehab check-in prescription consistency — build 30741
...
AI Running Coach v13.7.41 — live ASICS catalogue + gait-aware shoe planning — build 30741
...
AI Running Coach v13.7.41 — Shoes graph strategy control + Today visual lock — build 30741
...
AI Running Coach v13.7.41 — hard run-detail spacing + Today teal visual lock — build 30741
...
AI Running Coach v13.7.41 — run duration input + log popup spacing — build 30741
...
AI Running Coach v13.7.41 — authoritative shoe reassignment for logged runs and rehab — build 30741
...
AI Running Coach v13.7.41 — permanent shoe deletion — build 30741
...
AI Running Coach v13.7.41 — rehab shoe persistence + hard shoe lifecycle boundaries — build 30741
...
AI Running Coach v13.7.41 — rehab shoe selection persistence fix — build 30741
...
AI Running Coach v13.7.41 — shoe lifecycle + rehab mileage integrity — build 30741
...
AI Running Coach v13.7.41 — physical-pair lifecycle rollover — build 30741
...
AI Running Coach v13.7.41 — cross-source rehab/run mileage deduplication — build 30741
...
AI Running Coach v13.7.41 — atomic rehab shoe usage — build 30741
...
AI Running Coach v13.7.41 — rehab shoe-mileage estimation fix — build 30741
...
AI Running Coach v13.7.41 — shoe planner render hotfix — build 30741
...
AI Running Coach v13.7.41 — portfolio-optimised shoe purchasing — build 30741
...
AI Running Coach v13.7.41 — visible shoe-mileage confirmation — build 30741
...
AI Running Coach v13.7.41 — immediate shoe-mileage refresh after activity save — build 30741
...
AI Running Coach v13.7.41 — completed-day rehab freeze + future-only shoe projection — build 30741
...
AI Running Coach v13.7.41 — linked shoe-graph lifecycle events — build 30741
...
- VERSION 13.7.41 · BUILD 30741 · SCHEMA 10400.
