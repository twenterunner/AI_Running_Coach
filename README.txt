AI Running Coach v13.7.53 — retirement-bounded graph + 25% active-rotation floor — build 30753
...
AI Running Coach v13.7.53 — portfolio-first evidence-informed shoe engine — build 30753
...
AI Running Coach v13.7.53 — lifecycle consistency + Race Day hard target — build 30753
...
AI Running Coach v13.7.53 — shoe purchase/use + Race Day target integrity — build 30753
...
AI Running Coach v13.7.53 — offline ASICS catalogue + rational physical-pair lifecycle planner — build 30753
...
AI Running Coach v13.7.53 — differentiated shoe strategies, current-model purchasing, slope explanations, 3-back/4-ahead rehab — build 30753
...
AI Running Coach v13.7.53 — fresh physical-pair lifecycle planner + date-anchored rehab Today — build 30753
...
AI Running Coach v13.7.53 — graph-adjacent shoe strategy + verified live ASICS plan context — build 30753
...
- Corrects runtime and visible revision to v13.7.53 build 30753.
...
AI Running Coach v13.7.53 — rehab check-in prescription consistency — build 30753
...
AI Running Coach v13.7.53 — live ASICS catalogue + gait-aware shoe planning — build 30753
...
AI Running Coach v13.7.53 — Shoes graph strategy control + Today visual lock — build 30753
...
AI Running Coach v13.7.53 — hard run-detail spacing + Today teal visual lock — build 30753
...
AI Running Coach v13.7.53 — run duration input + log popup spacing — build 30753
...
AI Running Coach v13.7.53 — authoritative shoe reassignment for logged runs and rehab — build 30753
...
AI Running Coach v13.7.53 — permanent shoe deletion — build 30753
...
AI Running Coach v13.7.53 — rehab shoe persistence + hard shoe lifecycle boundaries — build 30753
...
AI Running Coach v13.7.53 — rehab shoe selection persistence fix — build 30753
...
AI Running Coach v13.7.53 — shoe lifecycle + rehab mileage integrity — build 30753
...
AI Running Coach v13.7.53 — physical-pair lifecycle rollover — build 30753
...
AI Running Coach v13.7.53 — cross-source rehab/run mileage deduplication — build 30753
...
AI Running Coach v13.7.53 — atomic rehab shoe usage — build 30753
...
AI Running Coach v13.7.53 — rehab shoe-mileage estimation fix — build 30753
...
AI Running Coach v13.7.53 — shoe planner render hotfix — build 30753
...
AI Running Coach v13.7.53 — portfolio-optimised shoe purchasing — build 30753
...
AI Running Coach v13.7.53 — visible shoe-mileage confirmation — build 30753
...
AI Running Coach v13.7.53 — immediate shoe-mileage refresh after activity save — build 30753
...
AI Running Coach v13.7.53 — completed-day rehab freeze + future-only shoe projection — build 30753
...
AI Running Coach v13.7.53 — linked shoe-graph lifecycle events — build 30753
...
- VERSION 13.7.53 · BUILD 30753 · SCHEMA 10400.
