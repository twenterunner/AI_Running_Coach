AI Running Coach v10.0.31 Stable — build 10310
...
Replace all six application files in the GitHub Pages repository. Retain the existing icon files. Fully close and reopen the installed PWA so cache build 10310 activates.

Build 10310 cumulative-pathway update:
...
- Header, manifest, schema, asset references and service-worker cache are aligned to build 10310.
