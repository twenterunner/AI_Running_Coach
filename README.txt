AI Running Coach v13.7.42 — resilient ASICS live transport — build 30742

- Adds AllOrigins raw CORS and JSONP fallback transports for ASICS live catalogue refresh.
- Live refresh now tries Jina Reader, AllOrigins raw, direct ASICS, and AllOrigins JSONP.
- Official ASICS pages remain the information source; proxy services are transport only.
- Successful refresh records the transport used.
- Failure diagnostics now list the failed transports.
- Cached/local shoe catalogue remains available offline.
- No training, prediction, recovery, rehabilitation, pathway, scoring or shoe-mileage calculations changed.
- Schema remains 10400.

AI Running Coach v13.7.42 — ASICS live catalogue discovery fix — build 30742
...
AI Running Coach v13.7.42 — shoe-context save + ASICS live refresh + graph-adjacent approach selector — build 30742
...
AI Running Coach v13.7.42 — rehab check-in prescription consistency — build 30742
...
AI Running Coach v13.7.42 — live ASICS catalogue + gait-aware shoe planning — build 30742
...
AI Running Coach v13.7.42 — Shoes graph strategy control + Today visual lock — build 30742
...
AI Running Coach v13.7.42 — hard run-detail spacing + Today teal visual lock — build 30742
...
AI Running Coach v13.7.42 — run duration input + log popup spacing — build 30742
...
AI Running Coach v13.7.42 — authoritative shoe reassignment for logged runs and rehab — build 30742
...
AI Running Coach v13.7.42 — permanent shoe deletion — build 30742
...
AI Running Coach v13.7.42 — rehab shoe persistence + hard shoe lifecycle boundaries — build 30742
...
AI Running Coach v13.7.42 — rehab shoe selection persistence fix — build 30742
...
AI Running Coach v13.7.42 — shoe lifecycle + rehab mileage integrity — build 30742
...
AI Running Coach v13.7.42 — physical-pair lifecycle rollover — build 30742
...
AI Running Coach v13.7.42 — cross-source rehab/run mileage deduplication — build 30742
...
AI Running Coach v13.7.42 — atomic rehab shoe usage — build 30742
...
AI Running Coach v13.7.42 — rehab shoe-mileage estimation fix — build 30742
...
AI Running Coach v13.7.42 — shoe planner render hotfix — build 30742
...
AI Running Coach v13.7.42 — portfolio-optimised shoe purchasing — build 30742
...
AI Running Coach v13.7.42 — visible shoe-mileage confirmation — build 30742
...
AI Running Coach v13.7.42 — immediate shoe-mileage refresh after activity save — build 30742
...
AI Running Coach v13.7.42 — completed-day rehab freeze + future-only shoe projection — build 30742
...
AI Running Coach v13.7.42 — linked shoe-graph lifecycle events — build 30742
...
- VERSION 13.7.42 · BUILD 30742 · SCHEMA 10400.
