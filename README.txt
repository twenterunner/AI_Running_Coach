AI Running Coach v13.7.56 — fixed three-mode shoe strategy engine — build 30756
...
AI Running Coach v13.7.56 — continuous active rotation — build 30756
...
AI Running Coach v13.7.56 — retirement-bounded graph + 25% active-rotation floor — build 30756
...
AI Running Coach v13.7.56 — portfolio-first evidence-informed shoe engine — build 30756
...
AI Running Coach v13.7.56 — lifecycle consistency + Race Day hard target — build 30756
...
AI Running Coach v13.7.56 — shoe purchase/use + Race Day target integrity — build 30756
...
AI Running Coach v13.7.56 — offline ASICS catalogue + rational physical-pair lifecycle planner — build 30756
...
AI Running Coach v13.7.56 — differentiated shoe strategies, current-model purchasing, slope explanations, 3-back/4-ahead rehab — build 30756
...
AI Running Coach v13.7.56 — fresh physical-pair lifecycle planner + date-anchored rehab Today — build 30756
...
AI Running Coach v13.7.56 — graph-adjacent shoe strategy + verified live ASICS plan context — build 30756
...
- Corrects runtime and visible revision to v13.7.56 build 30756.
...
AI Running Coach v13.7.56 — rehab check-in prescription consistency — build 30756
...
AI Running Coach v13.7.56 — live ASICS catalogue + gait-aware shoe planning — build 30756
...
AI Running Coach v13.7.56 — Shoes graph strategy control + Today visual lock — build 30756
...
AI Running Coach v13.7.56 — hard run-detail spacing + Today teal visual lock — build 30756
...
AI Running Coach v13.7.56 — run duration input + log popup spacing — build 30756
...
AI Running Coach v13.7.56 — authoritative shoe reassignment for logged runs and rehab — build 30756
...
AI Running Coach v13.7.56 — permanent shoe deletion — build 30756
...
AI Running Coach v13.7.56 — rehab shoe persistence + hard shoe lifecycle boundaries — build 30756
...
AI Running Coach v13.7.56 — rehab shoe selection persistence fix — build 30756
...
AI Running Coach v13.7.56 — shoe lifecycle + rehab mileage integrity — build 30756
...
AI Running Coach v13.7.56 — physical-pair lifecycle rollover — build 30756
...
AI Running Coach v13.7.56 — cross-source rehab/run mileage deduplication — build 30756
...
AI Running Coach v13.7.56 — atomic rehab shoe usage — build 30756
...
AI Running Coach v13.7.56 — rehab shoe-mileage estimation fix — build 30756
...
AI Running Coach v13.7.56 — shoe planner render hotfix — build 30756
...
AI Running Coach v13.7.56 — portfolio-optimised shoe purchasing — build 30756
...
AI Running Coach v13.7.56 — visible shoe-mileage confirmation — build 30756
...
AI Running Coach v13.7.56 — immediate shoe-mileage refresh after activity save — build 30756
...
AI Running Coach v13.7.56 — completed-day rehab freeze + future-only shoe projection — build 30756
...
AI Running Coach v13.7.56 — linked shoe-graph lifecycle events — build 30756
...
- VERSION 13.7.56 · BUILD 30756 · SCHEMA 10400.
