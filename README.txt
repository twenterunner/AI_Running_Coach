AI Running Coach v13.7.46 — fresh physical-pair lifecycle planner + date-anchored rehab Today — build 30746
...
AI Running Coach v13.7.46 — graph-adjacent shoe strategy + verified live ASICS plan context — build 30746
...
AI Running Coach v13.7.46 — Shoes simplification + resilient ASICS live refresh — build 30746

- Corrects runtime and visible revision to v13.7.46 build 30746.
...
AI Running Coach v13.7.46 — ASICS live catalogue discovery fix — build 30746
...
AI Running Coach v13.7.46 — shoe-context save + ASICS live refresh + graph-adjacent approach selector — build 30746
...
AI Running Coach v13.7.46 — rehab check-in prescription consistency — build 30746
...
AI Running Coach v13.7.46 — live ASICS catalogue + gait-aware shoe planning — build 30746
...
AI Running Coach v13.7.46 — Shoes graph strategy control + Today visual lock — build 30746
...
AI Running Coach v13.7.46 — hard run-detail spacing + Today teal visual lock — build 30746
...
AI Running Coach v13.7.46 — run duration input + log popup spacing — build 30746
...
AI Running Coach v13.7.46 — authoritative shoe reassignment for logged runs and rehab — build 30746
...
AI Running Coach v13.7.46 — permanent shoe deletion — build 30746
...
AI Running Coach v13.7.46 — rehab shoe persistence + hard shoe lifecycle boundaries — build 30746
...
AI Running Coach v13.7.46 — rehab shoe selection persistence fix — build 30746
...
AI Running Coach v13.7.46 — shoe lifecycle + rehab mileage integrity — build 30746
...
AI Running Coach v13.7.46 — physical-pair lifecycle rollover — build 30746
...
AI Running Coach v13.7.46 — cross-source rehab/run mileage deduplication — build 30746
...
AI Running Coach v13.7.46 — atomic rehab shoe usage — build 30746
...
AI Running Coach v13.7.46 — rehab shoe-mileage estimation fix — build 30746
...
AI Running Coach v13.7.46 — shoe planner render hotfix — build 30746
...
AI Running Coach v13.7.46 — portfolio-optimised shoe purchasing — build 30746
...
AI Running Coach v13.7.46 — visible shoe-mileage confirmation — build 30746
...
AI Running Coach v13.7.46 — immediate shoe-mileage refresh after activity save — build 30746
...
AI Running Coach v13.7.46 — completed-day rehab freeze + future-only shoe projection — build 30746
...
AI Running Coach v13.7.46 — linked shoe-graph lifecycle events — build 30746
...
- VERSION 13.7.46 · BUILD 30746 · SCHEMA 10400.
