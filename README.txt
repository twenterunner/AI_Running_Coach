AI Running Coach v10.0.42 Stable — build 10420
...
After upgrading an installed PWA, fully close and reopen it once so cache arc-v1042-stable-10420-premium1 activates. Existing v10.x local data are migrated into schema 10330 and retained under a deterministic primary/mirror storage pair.
...
v10.0.42 Post-run Coach Update
-----------------------------
...
v10.0.42 Post-run prescription impact and mobile modal fix
----------------------------------------------------------
...
v10.0.42 Weekly pathway commitment
----------------------------------
...
v10.0.42 Scheduled-activity progression fix
-------------------------------------------
...
v10.0.42 Bottom navigation interaction fix
------------------------------------------
