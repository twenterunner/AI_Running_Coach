AI Running Coach v10.4.2 Stable — build 14020
...
After upgrading an installed PWA, fully close and reopen it once so cache arc-v1042-stable-14020-premium1 activates. Existing v10.x local data are migrated into schema 10330 and retained under a deterministic primary/mirror storage pair.
...
v10.4.2 Post-run prescription impact and mobile modal fix
----------------------------------------------------------
...
v10.4.2 Weekly pathway commitment
----------------------------------
...
v10.4.2 Scheduled-activity progression fix
-------------------------------------------
...
v10.4.2 Bottom navigation interaction fix
------------------------------------------
...
v10.4.2 Today simplification and evidence clarity
--------------------------------------------------
...
v10.4.2: Top header AI Running Coach title is larger, heavier and pure white.


v10.4.2 Coach-perspective separation
-------------------------------------
...
v10.4.2 Interval FIT intelligence + Weekly Review
--------------------------------------------------
...
v10.4.2 Weekly review pathway clarification
--------------------------------------------
...
v10.4.2 Record-stream interval detection
-----------------------------------------
...
v10.4.2 Stryd per-repetition power + interval score transparency
-----------------------------------------------------------------
...
v10.4.2 Native + developer FIT record power
--------------------------------------------
...
v10.4.2 Drift chart FIT-stream repair
--------------------------------------
...
v10.4.2: Renamed Strength between running exposures to Strength & recovery day; removed WHY THIS IS TODAY'S CALL, the Today-vs-Progress scope footer, and the Progress expand-conclusion instruction.


v10.4.2: Progress Snapshot reordered: Week Distance + Readiness on row 1; Pace & Power + Distance & Load on row 2.


v10.4.2 Readiness Center
-------------------------
...
v10.4.2 Rehabilitation adherence correction
---------------------------------------------
...
v10.4.2 Workout Intelligence 2.0 + Comparable Runs
--------------------------------------------------
...
v10.4.2 Training Decision Engine
--------------------------------
...
v10.4.2 Personal Response Model
-------------------------------
...
v10.4.2 Unified Two-Pathway Decision Engine
-------------------------------------------
...
v10.4.2 Evidence acceptance transparency
...
v10.4.2: Fixed accepted Distance & Load run contributions being omitted from the current-week bucket. Simplified post-run pathway UI to Run evidence → Acceptance → This week → Projected next factor; removed duplicate Why/What changed text and repeated numbers.
