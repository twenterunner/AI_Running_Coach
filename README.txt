AI Running Coach v13.7.57 — expert shoe lifecycle continuity + event-cause fix — build 30757
...
AI Running Coach v13.7.57 — fixed three-mode shoe strategy engine — build 30757
...
AI Running Coach v13.7.57 — continuous active rotation — build 30757
...
AI Running Coach v13.7.57 — retirement-bounded graph + 25% active-rotation floor — build 30757
...
AI Running Coach v13.7.57 — portfolio-first evidence-informed shoe engine — build 30757
...
AI Running Coach v13.7.57 — lifecycle consistency + Race Day hard target — build 30757
...
AI Running Coach v13.7.57 — shoe purchase/use + Race Day target integrity — build 30757
...
AI Running Coach v13.7.57 — offline ASICS catalogue + rational physical-pair lifecycle planner — build 30757
...
AI Running Coach v13.7.57 — differentiated shoe strategies, current-model purchasing, slope explanations, 3-back/4-ahead rehab — build 30757
...
AI Running Coach v13.7.57 — fresh physical-pair lifecycle planner + date-anchored rehab Today — build 30757
...
AI Running Coach v13.7.57 — graph-adjacent shoe strategy + verified live ASICS plan context — build 30757
...
- Corrects runtime and visible revision to v13.7.57 build 30757.
...
AI Running Coach v13.7.57 — rehab check-in prescription consistency — build 30757
...
AI Running Coach v13.7.57 — live ASICS catalogue + gait-aware shoe planning — build 30757
...
AI Running Coach v13.7.57 — Shoes graph strategy control + Today visual lock — build 30757
...
AI Running Coach v13.7.57 — hard run-detail spacing + Today teal visual lock — build 30757
...
AI Running Coach v13.7.57 — run duration input + log popup spacing — build 30757
...
AI Running Coach v13.7.57 — authoritative shoe reassignment for logged runs and rehab — build 30757
...
AI Running Coach v13.7.57 — permanent shoe deletion — build 30757
...
AI Running Coach v13.7.57 — rehab shoe persistence + hard shoe lifecycle boundaries — build 30757
...
AI Running Coach v13.7.57 — rehab shoe selection persistence fix — build 30757
...
AI Running Coach v13.7.57 — shoe lifecycle + rehab mileage integrity — build 30757
...
AI Running Coach v13.7.57 — physical-pair lifecycle rollover — build 30757
...
AI Running Coach v13.7.57 — cross-source rehab/run mileage deduplication — build 30757
...
AI Running Coach v13.7.57 — atomic rehab shoe usage — build 30757
...
AI Running Coach v13.7.57 — rehab shoe-mileage estimation fix — build 30757
...
AI Running Coach v13.7.57 — shoe planner render hotfix — build 30757
...
AI Running Coach v13.7.57 — portfolio-optimised shoe purchasing — build 30757
...
AI Running Coach v13.7.57 — visible shoe-mileage confirmation — build 30757
...
AI Running Coach v13.7.57 — immediate shoe-mileage refresh after activity save — build 30757
...
AI Running Coach v13.7.57 — completed-day rehab freeze + future-only shoe projection — build 30757
...
AI Running Coach v13.7.57 — linked shoe-graph lifecycle events — build 30757
...
- VERSION 13.7.57 · BUILD 30757 · SCHEMA 10400.
