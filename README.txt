AI Running Coach v10.0.8 Stable — build 10080
...
Deployment:
Replace all six application files in the GitHub Pages repository. Retain the existing icon files. Fully close and reopen the installed PWA so cache build 10080 activates.
...
v10.0.8 Injury status wording and release consistency
...
- Aligns visible header, runtime header override, console version, manifest, asset query strings, service-worker cache and README to v10.0.8 build 10080.


v10.0.8 Injury execution update
