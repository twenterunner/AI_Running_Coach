AI Running Coach v10.4.0 Stable — build 14000
...
After upgrading an installed PWA, fully close and reopen it once so cache arc-v1040-stable-14000-premium1 activates. Existing v10.x local data are migrated into schema 10330 and retained under a deterministic primary/mirror storage pair.
...
v10.4.0 Post-run prescription impact and mobile modal fix
----------------------------------------------------------
...
v10.4.0 Weekly pathway commitment
----------------------------------
...
v10.4.0 Scheduled-activity progression fix
-------------------------------------------
...
v10.4.0 Bottom navigation interaction fix
------------------------------------------
...
v10.4.0 Today simplification and evidence clarity
--------------------------------------------------
...
v10.4.0: Top header AI Running Coach title is larger, heavier and pure white.


v10.4.0 Coach-perspective separation
-------------------------------------
...
v10.4.0 Interval FIT intelligence + Weekly Review
--------------------------------------------------
...
v10.4.0 Weekly review pathway clarification
--------------------------------------------
...
v10.4.0 Record-stream interval detection
-----------------------------------------
...
v10.4.0 Stryd per-repetition power + interval score transparency
-----------------------------------------------------------------
...
v10.4.0 Native + developer FIT record power
--------------------------------------------
...
v10.4.0 Drift chart FIT-stream repair
--------------------------------------
...
v10.4.0: Renamed Strength between running exposures to Strength & recovery day; removed WHY THIS IS TODAY'S CALL, the Today-vs-Progress scope footer, and the Progress expand-conclusion instruction.


v10.4.0: Progress Snapshot reordered: Week Distance + Readiness on row 1; Pace & Power + Distance & Load on row 2.


v10.4.0 Readiness Center
-------------------------
...
v10.4.0 Rehabilitation adherence correction
---------------------------------------------
...
v10.4.0 Workout Intelligence 2.0 + Comparable Runs
--------------------------------------------------
...
v10.4.0 Training Decision Engine
--------------------------------
...
v10.4.0 Personal Response Model
-------------------------------
...
v10.4.0 Unified Two-Pathway Decision Engine
-------------------------------------------
