AI Running Coach v10.0.54 Stable — build 10540
...
After upgrading an installed PWA, fully close and reopen it once so cache arc-v1054-stable-10540-premium1 activates. Existing v10.x local data are migrated into schema 10330 and retained under a deterministic primary/mirror storage pair.
...
v10.0.54 Post-run Coach Update
-----------------------------
...
v10.0.54 Post-run prescription impact and mobile modal fix
----------------------------------------------------------
...
v10.0.54 Weekly pathway commitment
----------------------------------
...
v10.0.54 Scheduled-activity progression fix
-------------------------------------------
...
v10.0.54 Bottom navigation interaction fix
------------------------------------------
...
v10.0.54 Today simplification and evidence clarity
--------------------------------------------------
...
v10.0.54: Top header AI Running Coach title is larger, heavier and pure white.


v10.0.54 Coach-perspective separation
-------------------------------------
...
v10.0.54 Interval FIT intelligence + Weekly Review
--------------------------------------------------
...
v10.0.54 Weekly review pathway clarification
--------------------------------------------
...
v10.0.54 Record-stream interval detection
-----------------------------------------
...
v10.0.54 Stryd per-repetition power + interval score transparency
-----------------------------------------------------------------
...
v10.0.54 Native + developer FIT record power
--------------------------------------------
...
v10.0.54 Drift chart FIT-stream repair
--------------------------------------
...
v10.0.54: Renamed Strength between running exposures to Strength & recovery day; removed WHY THIS IS TODAY'S CALL, the Today-vs-Progress scope footer, and the Progress expand-conclusion instruction.


v10.0.54: Progress Snapshot reordered: Week Distance + Readiness on row 1; Pace & Power + Distance & Load on row 2.


v10.0.54 Readiness Center
-------------------------
