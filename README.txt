AI Running Coach v13.7.50 — shoe purchase/use + Race Day target integrity — build 30750
...
AI Running Coach v13.7.50 — offline ASICS catalogue + rational physical-pair lifecycle planner — build 30750
...
AI Running Coach v13.7.50 — differentiated shoe strategies, current-model purchasing, slope explanations, 3-back/4-ahead rehab — build 30750
...
AI Running Coach v13.7.50 — fresh physical-pair lifecycle planner + date-anchored rehab Today — build 30750
...
AI Running Coach v13.7.50 — graph-adjacent shoe strategy + verified live ASICS plan context — build 30750
...
- Corrects runtime and visible revision to v13.7.50 build 30750.
...
AI Running Coach v13.7.50 — rehab check-in prescription consistency — build 30750
...
AI Running Coach v13.7.50 — live ASICS catalogue + gait-aware shoe planning — build 30750
...
AI Running Coach v13.7.50 — Shoes graph strategy control + Today visual lock — build 30750
...
AI Running Coach v13.7.50 — hard run-detail spacing + Today teal visual lock — build 30750
...
AI Running Coach v13.7.50 — run duration input + log popup spacing — build 30750
...
AI Running Coach v13.7.50 — authoritative shoe reassignment for logged runs and rehab — build 30750
...
AI Running Coach v13.7.50 — permanent shoe deletion — build 30750
...
AI Running Coach v13.7.50 — rehab shoe persistence + hard shoe lifecycle boundaries — build 30750
...
AI Running Coach v13.7.50 — rehab shoe selection persistence fix — build 30750
...
AI Running Coach v13.7.50 — shoe lifecycle + rehab mileage integrity — build 30750
...
AI Running Coach v13.7.50 — physical-pair lifecycle rollover — build 30750
...
AI Running Coach v13.7.50 — cross-source rehab/run mileage deduplication — build 30750
...
AI Running Coach v13.7.50 — atomic rehab shoe usage — build 30750
...
AI Running Coach v13.7.50 — rehab shoe-mileage estimation fix — build 30750
...
AI Running Coach v13.7.50 — shoe planner render hotfix — build 30750
...
AI Running Coach v13.7.50 — portfolio-optimised shoe purchasing — build 30750
...
AI Running Coach v13.7.50 — visible shoe-mileage confirmation — build 30750
...
AI Running Coach v13.7.50 — immediate shoe-mileage refresh after activity save — build 30750
...
AI Running Coach v13.7.50 — completed-day rehab freeze + future-only shoe projection — build 30750
...
AI Running Coach v13.7.50 — linked shoe-graph lifecycle events — build 30750
...
- VERSION 13.7.50 · BUILD 30750 · SCHEMA 10400.
