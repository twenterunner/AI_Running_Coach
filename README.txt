AI Running Coach v10.5.1 Stable — build 15010
...
After upgrading an installed PWA, fully close and reopen it once so cache arc-v1051-stable-15010-premium1 activates. Existing v10.x local data are migrated into schema 10330 and retained under a deterministic primary/mirror storage pair.
...
v10.5.1 Post-run prescription impact and mobile modal fix
----------------------------------------------------------
...
v10.5.1 Weekly pathway commitment
----------------------------------
...
v10.5.1 Scheduled-activity progression fix
-------------------------------------------
...
v10.5.1 Bottom navigation interaction fix
------------------------------------------
...
v10.5.1 Today simplification and evidence clarity
--------------------------------------------------
...
v10.5.1: Top header AI Running Coach title is larger, heavier and pure white.


v10.5.1 Coach-perspective separation
-------------------------------------
...
v10.5.1 Interval FIT intelligence + Weekly Review
--------------------------------------------------
...
v10.5.1 Weekly review pathway clarification
--------------------------------------------
...
v10.5.1 Record-stream interval detection
-----------------------------------------
...
v10.5.1 Stryd per-repetition power + interval score transparency
-----------------------------------------------------------------
...
v10.5.1 Native + developer FIT record power
--------------------------------------------
...
v10.5.1 Drift chart FIT-stream repair
--------------------------------------
...
v10.5.1: Renamed Strength between running exposures to Strength & recovery day; removed WHY THIS IS TODAY'S CALL, the Today-vs-Progress scope footer, and the Progress expand-conclusion instruction.


v10.5.1: Progress Snapshot reordered: Week Distance + Readiness on row 1; Pace & Power + Distance & Load on row 2.


v10.5.1 Readiness Center
-------------------------
...
v10.5.1 Rehabilitation adherence correction
---------------------------------------------
...
v10.5.1 Workout Intelligence 2.0 + Comparable Runs
--------------------------------------------------
...
v10.5.1 Training Decision Engine
--------------------------------
...
v10.5.1 Personal Response Model
-------------------------------
...
v10.5.1 Unified Two-Pathway Decision Engine
-------------------------------------------
...
v10.5.1 Evidence acceptance transparency
...
v10.5.1: Fixed accepted Distance & Load run contributions being omitted from the current-week bucket. Simplified post-run pathway UI to Run evidence → Acceptance → This week → Projected next factor; removed duplicate Why/What changed text and repeated numbers.


v10.5.1: Fixed circular JSON save error by removing persisted pathwayTrace/twoPathway objects from coachUpdate. Pathway traces are recomputed on view and contain only plain date/type/contribution rows. Weekly buckets count only non-zero accepted contributions. Post-run UI reduced to Run signal, Accepted into learning, This week, Projected factor, with details behind one foldout.


v10.5.1 Personal-model classification + pathway tile consistency
-----------------------------------------------------------------
...
v10.5.1: Renamed evidence weight to learning confidence weight; shows analysed vs contributed run counts; calculation details expose base confidence weight and multipliers.


v10.5.1 Information architecture cleanup
-----------------------------------------
...
v10.5.1 Progress navigation + duplicate cleanup
-----------------------------------------------
...
v10.5.1 Auditable pathway calculations
---------------------------------------
