AI Running Coach v9.3.6 Stable — build 9360
...
- Updates schema, manifest and service-worker cache to build 9360.
...
Deployment
Replace all six application files in the GitHub Pages repository. Retain the existing icon files. Fully close and reopen the installed PWA after deployment so cache build 9360 activates.
