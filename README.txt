AI Running Coach v10.0.19 Stable — build 10190
...
Deployment:
Replace all six application files in the GitHub Pages repository. Retain the existing icon files. Fully close and reopen the installed PWA so cache build 10190 activates.


v10.0.19 execution consistency fix
...
v10.0.19 Injury check-in update
...
v10.0.19 Daily check-in consistency
...
v10.0.19 Injury check-in consistency update
...
v10.0.19 contradiction-proof check-in
...
v10.0.19 Injury recommendation intelligence
