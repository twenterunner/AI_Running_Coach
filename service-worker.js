const CACHE='arc-v62-web-6206';
const ASSETS=['./','./index.html','./styles.css?v=6206','./app.js?v=6206','./manifest.webmanifest?v=6206','./icon-192.png?v=6206','./icon-512.png?v=6206'];
