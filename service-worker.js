const CACHE='arc-v62-web-6205';
const ASSETS=['./','./index.html','./styles.css?v=6205','./app.js?v=6205','./manifest.webmanifest?v=6205','./icon-192.png?v=6205','./icon-512.png?v=6205'];
