const CACHE='arc-v63-web-6300';
const ASSETS=['./','./index.html','./styles.css?v=6300','./app.js?v=6300','./manifest.webmanifest?v=6300','./icon-192.png?v=6300','./icon-512.png?v=6300'];
