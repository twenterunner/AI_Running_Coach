const CACHE='arc-v62-web-6208';
const ASSETS=['./','./index.html','./styles.css?v=6208','./app.js?v=6208','./manifest.webmanifest?v=6208','./icon-192.png?v=6208','./icon-512.png?v=6208'];
