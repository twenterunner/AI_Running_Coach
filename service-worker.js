const CACHE='arc-v63-web-6302';
const ASSETS=['./','./index.html','./styles.css?v=6302','./app.js?v=6302','./manifest.webmanifest?v=6302','./icon-192.png?v=6302','./icon-512.png?v=6302'];
