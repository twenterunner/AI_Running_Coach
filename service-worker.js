const CACHE='arc-v63-web-6305';
const ASSETS=['./','./index.html','./styles.css?v=6305','./app.js?v=6305','./manifest.webmanifest?v=6305','./icon-192.png?v=6305','./icon-512.png?v=6305'];
