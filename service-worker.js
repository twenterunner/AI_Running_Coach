const CACHE='arc-v62-web-6211';
const ASSETS=['./','./index.html','./styles.css?v=6211','./app.js?v=6211','./manifest.webmanifest?v=6211','./icon-192.png?v=6211','./icon-512.png?v=6211'];
