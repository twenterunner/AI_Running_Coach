const CACHE='arc-v63-web-6303';
const ASSETS=['./','./index.html','./styles.css?v=6303','./app.js?v=6303','./manifest.webmanifest?v=6303','./icon-192.png?v=6303','./icon-512.png?v=6303'];
