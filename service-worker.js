const CACHE='arc-v63-web-6307';
const ASSETS=['./','./index.html','./styles.css?v=6307','./app.js?v=6307','./manifest.webmanifest?v=6307','./icon-192.png?v=6307','./icon-512.png?v=6307'];
