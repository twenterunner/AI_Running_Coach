const CACHE='arc-v62-web-6209';
const ASSETS=['./','./index.html','./styles.css?v=6209','./app.js?v=6209','./manifest.webmanifest?v=6209','./icon-192.png?v=6209','./icon-512.png?v=6209'];
